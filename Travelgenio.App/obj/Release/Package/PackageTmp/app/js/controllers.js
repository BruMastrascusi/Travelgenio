'use strict';
app.controller('MainCtrl', ['$rootScope', '$state', '$scope', 'Autenticacion', '$http', 'ServiciosGlobales', '$cookies',
    function ($rootScope, $state, $scope, Autenticacion, $http, Srv, $cookies) {
        ...
        $rootScope.logout=function(){
            ...
            Srv.logout()
                .then(function(){
                    ...
                    delete $http.defaults.headers.common['Dominio'];
